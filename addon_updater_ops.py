...
updater.addon = "code_snippets_library"
...
def register(bl_info):
	...
	updater.user = "KoreTeknology"

	# choose your own repository, must match git name
	updater.repo = "code-snippets-library-addon-for-Blender"

	#updater.addon = # define at top of module, MUST be done first

	# Website for manual addon download, optional but recommended to set
	updater.website = "https://https://github.com/KoreTeknology/code-snippets-library-addon-for-Blender/"
